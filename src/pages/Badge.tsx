...
const Badge = () => {
  ...
  const shareText = useMemo(
    () => `I'm attending NextGen Summit 2026 as a ${trackLabel}! 🚀 Join me on October 17 at The Purple Place, Abuja.`,
    [trackLabel]
  );
        ...
        >
          ...
          <div className="text-center space-y-4">
            ...
            <div className="pt-2 space-y-0.5">
              <p className="text-[10px] text-muted-foreground">📅 October 17, 2026 · 10:00 AM</p>
